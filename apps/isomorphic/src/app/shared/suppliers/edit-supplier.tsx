...
import { AddressType, CustomErrorLogin, SupplierType } from '@/types';
...
export const EditSupplier = ({ getSuppliers, id }: EditSupplierProps) => {
   ...
   const onSubmit = async (data: SupplierFormData) => {
      ...
      try {
         await api.put(`/suppliers/${id}`, requestData);
   ...
   const getSupplierDetails = async () => {
      ...
      try {
         const response = await api.get<SupplierType>(`/suppliers/${id}`);
