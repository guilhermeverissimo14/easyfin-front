            ...
            <Container style={container}>
               ...
               <Section style={message}>
                  ...
                  <Text style={{ ...global.text, marginTop: 24 }}>
                     We´ve also charged your payment method for the cost of your
                     order and will be removing any authorization holds.
                  </Text>
               </Section>
               <Hr style={global.hr} />
               ...
               >
                  ...
                  <Text style={footer.text}>
                     © {new Date().getFullYear()} RedQ, Inc. All Rights
                     Reserved.
                  </Text>
                  <Text style={footer.text}>
                     RedQ, INC. One Bowerman Drive, Beaverton, Oregon 97005,
                     USA.
                  </Text>
               </Section>
            </Container>
